...
ax.set_title('Ratio of Electic Use to Weekly HDD Before 2020', color="black",fontsize=15,fontweight='bold')
...
plt.savefig('weekly_elec_use_hdd65_corr_lt2020.png', dpi=200)
plt.show()
plt.close()