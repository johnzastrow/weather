...
ax.set_xlabel('Weekly avg Temp F',fontsize=15,fontweight='bold')
ax.set_ylabel('Sum kwh per week',fontsize=15,fontweight='bold')
ax.set_title('Ratio of Electic Use to Weekly Temp F Avg 2020 and After', color="black",fontsize=15,fontweight='bold')
...
plt.savefig('weekly_elec_use_temp_corr_2020gt.png', dpi=200)
plt.show()
plt.close()