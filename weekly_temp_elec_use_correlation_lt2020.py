...
ax.set_title('Correlation of Electrons by Temp F Avg Before 2020', color="black",fontsize=15,fontweight='bold')
...
plt.savefig('weekly_elec_use_temp_corr_lt2020.png', dpi=200)
plt.show()
plt.close()