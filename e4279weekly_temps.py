...
### 2017 
my_query2017 = ''' SELECT `WEEKW`, `w_temp_f_avg` FROM `weather`.`v_e4279_weekly` WHERE (YEARY = 2017);'''
...
### 2018 
my_query2018 = ''' SELECT `WEEKW`, `w_temp_f_avg` FROM `weather`.`v_e4279_weekly` WHERE (YEARY = 2018);'''
...
### 2019 
my_query2019 = ''' SELECT `WEEKW`, `w_temp_f_avg` FROM `weather`.`v_e4279_weekly` WHERE (YEARY = 2019);'''
...
### 2019 
my_max = ''' SELECT max(WEEKW) as maxweek FROM `weather`.`v_e4279_weekly` WHERE (YEARY = 2019);'''
...
plt.minorticks_on()
plt.title("Weekly Air Temps (F) by Day of Year from Station e4279 on: "+ today)
...
plt.savefig('e4279weekly_temps_compare_years.png')
plt.show()
plt.close()