...
### 2018 
my_query2018 = ''' SELECT `WEEKW`, `w_temp_f_avg` FROM `weather`.`v_E4229_weekly` WHERE (YEARY = 2018) and WEEKW <= 52;'''
...
### 2019 
my_query2019 = ''' SELECT `WEEKW`, `w_temp_f_avg` FROM `weather`.`v_E4229_weekly` WHERE (YEARY = 2019) and WEEKW <= 52;'''
...
### 2020 
my_query2020 = ''' SELECT `WEEKW`, `w_temp_f_avg` FROM `weather`.`v_E4229_weekly` WHERE (YEARY = 2020) and WEEKW <= 52;'''
...
### Max  
my_max = ''' SELECT max(WEEKW) as maxweek FROM `weather`.`v_E4229_weekly` WHERE (YEARY = ''' + todayyear + ''');'''
