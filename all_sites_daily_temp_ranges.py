...
plt.errorbar(dater2018, tempf_vals2018, yerr = y_error, fmt='-o', ecolor='gray', label="2018", color='gray', elinewidth=4)
...
lower_y_error2017 = df1['temp_f_min']
upper_y_error2017 = df1['temp_f_max']
y_error = [lower_y_error2017, upper_y_error2017]
plt.errorbar(dater2017, tempf_vals2017, yerr = y_error, fmt='-o', ecolor='orange', label="2019", color='orange', elinewidth=2)
...
upper_y_error2017 = df1['temp_f_max']
y_error = [lower_y_error2017, upper_y_error2017]
plt.errorbar(dater2017, tempf_vals2017, yerr = y_error, fmt='-o', ecolor='blue', label="2019", color='blue')
...
plt.minorticks_on()
plt.title("Daily Air Temps (F) by Day Number at E on: "+ today)
